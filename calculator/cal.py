...
class Calculator:
    ...
    def create_display_frame(self):
        frame = tk.Frame(self.window, height=250,bg=LIGHT_GRAY)
    ...
    def create_display_label(self):
        ...
        label = tk.Label(self.display_frame,text=self.current_expression,anchor=tk.E,bg=LIGHT_GRAY,fg=LABEL_COLOR,padx=2,
